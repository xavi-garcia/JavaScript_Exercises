...
//then the conversion rate is unaffected by the technical difficulties. If a country's currency begins with a consonant, 
...
function convertMyDollars(usd, currency) {
    if (currency.charAt(0).match(/[aeiou]/gi)){
...
convertMyDollars(983, "Dominican Peso")
